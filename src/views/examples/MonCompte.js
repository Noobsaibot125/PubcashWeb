                                ...
                                <div className="bg-pubcash-light-green p-4 rounded h-100">
                                    <Form onSubmit={handleRecharge}>
                                        ...
                                        <div className="d-flex align-items-center">
                                            <span className="mr-3 font-weight-600 text-sm">Moyens de paiement :</span>
                                            <div className="d-flex">
                                                <PaymentIcon color="#ff6600" letter="O" name="Orange Money" />
                                                <PaymentIcon color="#ffcc00" letter="M" name="MTN Mobile Money" />
                                                <PaymentIcon color="#0052cc" letter="M" name="Moov Money" />
                                                <PaymentIcon color="#1da1f2" letter="W" name="Wave" />
                                            </div>
                                        </div>
                                    </Form>
                                </div>
